...
# The entire function is taken from RapidAPI Python example. 
...
def payout_winner(app_id, user1_uid, user2_uid, winner_addr, note1, note2): 
...
class Game:
    ...
    def winner(self):
        ...
        if p1 == "R" and p2 == "S":
            ...
            winner = 1
            winner_addr = user2_algo_addr
        payout_winner(app_id, user1_uid, user2_uid, winner_addr, p1, p2)
        return winner
